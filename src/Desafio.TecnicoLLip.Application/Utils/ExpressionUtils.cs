...
namespace Desafio.TecnicoLLip.Application.Utils
{
    public static class Constructor
    {
        public static T Create<T>(Action<T> init) where T : new()
        {
            var t = new T();
            init(t);
            return t;
    ...
    public static class ExpressionUtils
    {
                ...
                case ExpressionType.Conditional:
                    {
                        ...
                        var expressionIfFalse = co.IfFalse;
                        var expressionIfTrue = co.IfTrue;
        ...
        {
            return !keyObject.IsIn(collection);
        }
