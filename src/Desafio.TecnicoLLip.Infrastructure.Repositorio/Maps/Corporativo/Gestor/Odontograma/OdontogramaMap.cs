...
{
    public class OdontogramaMap : IEntityTypeConfiguration<Domain.Models.Corporativo.Gestor.Odontograma.Odontograma>
    {
        public void Configure(EntityTypeBuilder<Domain.Models.Corporativo.Gestor.Odontograma.Odontograma> builder)
        {
